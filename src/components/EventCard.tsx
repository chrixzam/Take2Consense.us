...
export function EventCard({ event, onVote, hasVoted, onDelete, onOpen }: EventCardProps) {
  ...
  return (
    <div
      className="bg-white/90 rounded-xl border border-gray-200 hover:border-gray-300 transition-all duration-200 overflow-hidden group hover:shadow-md cursor-pointer max-w-md mx-auto"
